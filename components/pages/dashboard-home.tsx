      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-8 lg:px-8">
        <Card className="border-none bg-gradient-to-r from-primary/20 via-primary/10 to-secondary/20 text-primary-foreground shadow-2xl">
          ...
          <CardContent className="flex flex-wrap gap-3">
            ...
            <Button variant="outline" className="bg-white/10 text-white hover:bg-white/20" onClick={() => onNavigate("browse")}>
              Browse items
            </Button>
          </CardContent>
        </Card>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card className="bg-primary text-primary-foreground">
            <CardHeader>
              ...
              <CardDescription className="text-primary-foreground/80">Share an item with your trusted circles</CardDescription>
            </CardHeader>
            <CardContent>
              <Button size="lg" variant="secondary" className="w-full" onClick={() => onNavigate("my-listings")}>
